...
export default function HoverButton({
  ...
  return (
    <div className="group h-fit w-fit md:h-[100px] flex flex-col md:items-center md:justify-center transition-all duration-500">
      ...
      <div className="h-0 overflow-hidden opacity-0 group-hover:opacity-100 flex flex-col gap-1 md:text-sm md:gap-3  group-hover:h-full bg-blue-50 md:group-hover:h-fit min-w-[145px] md:max-w-xs md:fixed md:top-[71px] lg:top-[91px] rounded-md md:bg-white md:border md:border-blue-100 md:ml-0 md:p-4 pt-1 ml-6 transition-all duration-500">
