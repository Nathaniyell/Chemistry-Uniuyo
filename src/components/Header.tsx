...
export default function Header({ headerBg, heading, tagline }: HeaderProps) {
  return (
    <header className="relative min-h-[30vh] w-full">
      <Image
        src={headerBg}
      ...
      <div className="flex flex-col items-center justify-center gap-3 bg-black/60 text-white min-h-[35vh] xs:min-h-[50vh] md:min-h-[70vh] p-4 z-10">
        <motion.h1
