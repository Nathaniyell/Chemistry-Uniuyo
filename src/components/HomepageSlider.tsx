...
const HomepageSlider = ({
  ...
  return (
    <div className={`relative aspect-h-5 aspect-w-4 md:aspect-h-2`}>
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white p-4 h-fit bg-black opacity-65 mx-auto w-[95%] md:w-3/4 flex flex-col justify-center gap-4">
        ...
        >
          {description
            ? description
            : " Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsam, voluptas exercitationem, ipsum, quod suscipit aliquid atque sunt labore at illum eaque veritatis ullam repellat mollitia? Eius aliquid ad, eaque repudiandae dolorum molestiae corporis nulla eum quidem! Natus libero, eaque commodi excepturi explicabo illo praesentium officia ab mollitia tempore voluptatum accusantium?"}
        </motion.p>
        {buttonVal && (
          <motion.div
            animate={{ opacity: 1 }}
