...
export const Button = ({
  ...
  return (
    ...
    >
      {children}{" "}
      {arrow && <MdOutlineKeyboardDoubleArrowRight className="text-2xl xs:text-xl opacity-0 translate-x-[500%] transition-all ease-linear duration-200 group-hover:translate-x-[20%] group-hover:opacity-100 lg:mt-1 text-secondary" />}
    </m.button>
  );
};
