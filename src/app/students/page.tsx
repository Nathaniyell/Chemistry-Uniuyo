"use client";
import { Header, Lecturers, RouteLinkBtn } from "@/components";
    ...
    return (
        <main className="bg-gradient-to-b from-[#eff5f5] to-white overflow-x-hidden">
            ...
            <section className="py-10 px-4 bg-gray-50">
                ...
                <div className="bg-orange-100 !mt-10 p-8 md:p-14 flex flex-col gap-10 md:flex-row justify-between items-center">
