...
export default function Home() {
  const headOfDepartment = [{title: "prof1",src:eduInam}, {title: "prof2",src:profInam}]
  return (
    <main className="w-full min-h-screen relative bg-slate-100">
      ...
      >
        {headOfDepartment.map(item=>(
          <SwiperSlide key={item.title} className="aspect-w-4 aspect-h-5 md:aspect-w-3 md:aspect-h-[3.45]">
