...
export const recentNews: recentNewsTypes[] = [
  ...
  },
  {
    date: "March 2026",
    title:
      "A Transformative Four-Year Legacy: Professor Edu Inam Concludes Tenure as Head of Department",
    description: [
      "As Professor Edu Inam concludes her tenure as Head of the Department of Chemistry, University of Uyo, the department looks back with gratitude and pride on a period of steady growth across teaching, research, infrastructure, student support, and community engagement. From March 2022 to March 2026, she led with a strong sense of inclusion and service, creating a calm working environment where staff were recognized, retirees were celebrated, welfare received attention, and collaboration remained strong across units.",
      "One of the most important achievements of the period was the successful National Universities Commission accreditation exercise, which earned the department FULL Accreditation for the Bachelor of Science (B.Sc.) Chemistry Programme, valid from 2024 to 2029. During the same period, the department strengthened its professional links with the Chemical Society of Nigeria, the American Chemical Society, and the Organisation for Women in Science for the Developing World (OwSD). The period also recorded promotions to professorial rank and stronger research output through grant-supported work and active scholarly participation.",
      "Academic delivery remained consistent and effective, with commendation from the University for timely graduation of students at both undergraduate and postgraduate levels. For the period under review, the department graduated a total of 193 undergraduate students and 19 postgraduate students. The period also recorded a historic student leadership milestone, as a Chemistry student emerged as the first Students' Union President from the Faculty of Science. In the same period, the department sustained strong academic and institutional growth through annual orientation programmes for freshmen and women. The department also successfully handled JUPEP examinations, migrated Year 1 and Year 2 examinations to Computer-Based Test (CBT), improved result processing with new desktop and laptop systems, produced updated Core Curriculum Minimum Academic Standards (CCMAS) and postgraduate handbooks after curriculum review, and improved visibility through the departmental website and lecture support systems.",
      "Across the same period, significant facility improvements made both teaching and research spaces more functional and safer. The department renovated, equipped, and commissioned its research laboratory, upgraded Chemistry Labs 1 and 2, rehabilitated the preparation room and weighing room, replaced damaged laboratory doors and window blinds, repaired and replaced key cooling systems, installed ceiling fans where needed, and procured essential laboratory and teaching support tools including public address systems, office furniture, laboratory equipment among others. Laboratories, offices, and surrounding spaces were also redecorated to maintain a more professional and conducive learning environment.",
  ...
  },
  {
    ...
    description: [
      ...
      "The research was conducted under the supervision of Dr. Nzikahyel Simon as the main supervisor and Prof. Atim Johnson as the co-supervisor. Dr. Simon's expert guidance and mentorship, along with Prof. Johnson's invaluable support, were instrumental in the successful completion of this research. Dr. Simon's expertise in inorganic chemistry and crystallography, combined with Prof. Johnson's knowledge in coordination chemistry and catalysis, provided valuable direction throughout the research journey.",
      ...
      "The Head of Department, Professor Edu Inam, extended heartfelt congratulations to Mr. Ekpoudo on this remarkable achievement and commended both Dr. Simon and Prof. Johnson for their outstanding supervision and commitment to nurturing research excellence in the department.",
  ...
  },
  {
    ...
    description: [
      ...
      "The research was supervised by Dr. Nzikahyel Simon as the main supervisor and Prof. Atim Johnson as the co-supervisor. Dr. Simon's expert guidance and mentorship, along with Prof. Johnson's invaluable support, were crucial to the successful completion of this work. Dr. Simon's expertise in inorganic chemistry and crystallography, combined with Prof. Johnson's knowledge in coordination chemistry and catalysis, provided the foundation for this innovative research.",
      ...
      "The Head of Department, Professor Edu Inam, congratulated Mr. Obong on his achievement and expressed appreciation to both Dr. Simon and Prof. Johnson for their dedicated supervision and contribution to the department's research excellence.",
