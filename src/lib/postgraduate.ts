...
export const postgraduateDetails = [
  {
    icon: SiMinds,
    heading: "PHILOSOPHY OF THE PROGRAMME",
    description:
  ...
  {
    icon: ListBulletIcon,
    heading: "OBJECTIVES OF THE PROGRAMME",
    description:
